...
(function($){
    ...
    $.supersized = function(options){
			...
			while(thisSlide <= base.options.slides.length-1){
				...
				if(thisSlide == base.options.start_slide-1){
					...
					if (base.options.thumb_links){
						...
						ThumbCateg = base.options.slides[thisSlide].categoria;
						thumbMarkers = thumbMarkers+'<li class="thumb'+thisSlide+' current-thumb '+ThumbCateg+'"><img src="'+thumbImage+'"/></li>';
					};
				}else{
					// Slide links
    	...
    	base._start = function(){
			...
			//$('#logotipo').css('color', api.getField('cor'));
